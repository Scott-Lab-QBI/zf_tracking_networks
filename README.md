...
The exported models can be used within Bonsai for offline and real-time tracking withing Bonsai-rx. For DLC, see [Bonsai-DLC](https://github.com/bonsai-rx/deeplabcut) and for SLEAP, see [SLEAP documentation](https://sleap.ai/develop/guides/bonsai.html) and [Bonsai-SLEAP](https://github.com/bonsai-rx/sleap). 
